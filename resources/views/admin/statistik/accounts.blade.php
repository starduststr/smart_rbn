...
<script type="text/javascript">
        ...
        $.each(data.data, function (key, account) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-sm btn-default" title="Delete" onclick="deleteAccount(this)" data-id="${account.id}"><i class="fa fa-trash"></i></button>
    ...
    $.ajax({
        ...
        data: data,
        success: function (response) {
            swal('Hapus akun berhasil!')
            // Hapus baris yang bersangkutan
            d.closest('tr').remove();
        },
        error: function (e) {
            swal('Hapus akun belum berhasil, silahkan coba lagi!')
        }
    });
}
