            ...
            <div class="body">
                <div class="d-flex flex-row flex-wrap justify-content-center align-items-center w-100">
                    <div class="col text-center text-sm-right">
                        <h3 class="bold" style="color: #4BCAE3">500!</h3>
                        <h3 class="bold" style="color: #00B4D8">Yahh,</h3>
                        <h3 class="bold" style="color: #00B4D8">Internal Server Error.</h3>
                        <a href="{{ route('dashboard') }}" style="color: #4BCAE3"><i class="fa fa-chevron-left font-11"></i> Kembali</a>
                    </div>
                    <div class="col">
                        <img class="img-fluid" src="{{asset('assets/images/3805088 1.svg')}}" style="min-width: 260px;"/>
                    </div>
                </div>
                <div class="pattern">
                    <span class="red"></span>
